    ...
    public void run(IProgressMonitor monitor) throws InvocationTargetException, InterruptedException {
        ...
        try {
            ...
            if (passwordData != null && server.isConnected() && passwordData.isSavePassword()) {
                ...
                String promptPrefName = EmailModel.getPrefName(server.getId(), EmailModel.PASSWORD_PROMPT);
                String passwordPrefName = EmailModel.getPrefName(server.getId(), EmailModel.PASSWORD);
